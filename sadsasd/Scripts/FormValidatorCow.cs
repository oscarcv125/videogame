...
public class FormValidatorCow : MonoBehaviour
{
    ...
    private readonly string expectedAnimalType = "Mammal";
    private readonly string expectedObservationType = "Seen";
    private readonly int expectedIndividualCount = 3;
    private readonly string[] acceptedNames = { "cow", "vaca" };
